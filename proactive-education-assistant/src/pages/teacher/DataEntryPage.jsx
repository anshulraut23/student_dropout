...
import { FaCalendarCheck, FaBook, FaUserCheck } from "react-icons/fa";
    ...
    <div className="p-4 md:p-6 pt-20 md:pt-6 min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-4 md:mb-6">
          ...
          <p className="text-xs md:text-sm text-gray-500 mt-1">Record attendance, scores, and behaviour observations</p>
        </div>
