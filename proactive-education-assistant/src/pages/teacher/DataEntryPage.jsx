...
export default function DataEntryPage() {
  ...
  const tabs = [
    ...
    { id: "scores", label: "Scores", icon: FaBook },
    { id: "behaviour", label: "Behaviour", icon: FaUserCheck },
    { id: "interventions", label: "Interventions", icon: FaHandsHelping }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50" style={{ paddingTop: '5rem' }}>
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-2xl md:text-3xl font-semibold text-gray-900">Data Entry</h1>
          <p className="text-sm text-gray-500 mt-1">
            Record attendance, scores, behaviour observations, and interventions
          </p>
        </div>
