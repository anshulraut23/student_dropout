...
export default function PricingTable() {
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br ${theme === 'dark' ? 'from-slate-900 to-gray-900' : 'from-slate-50 to-blue-50'} p-8`}>
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 relative">
            ...
            <div className="relative bg-gradient-to-br from-white to-blue-50 dark:from-gray-800 dark:to-gray-900 rounded-3xl p-8 shadow-2xl border border-gray-100 dark:border-gray-700">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-100 to-blue-100 dark:from-purple-900/50 dark:to-blue-900/50 text-purple-700 dark:text-purple-300 rounded-full text-sm font-semibold mb-6">
              ...
              <p className={`text-lg ${theme === 'dark' ? 'text-slate-300' : 'text-slate-600'} mb-8 leading-relaxed`}>
                Unlock all features to maximize student success and prevent dropouts with our comprehensive education platform.
              </p>

              {/* CTA Button */}
              <button onClick={() => navigate('/payment')} className="w-full bg-gradient-to-r from-blue-600 via-purple-600 to-teal-600 text-white font-bold py-5 rounded-2xl hover:shadow-2xl hover:scale-105 transition-all duration-300 mb-6 relative overflow-hidden group">
              ...
              <p className={`text-sm ${theme === 'dark' ? 'text-slate-400' : 'text-slate-500'} text-center mb-6`}>
          ...
          <div className={`lg:col-span-2 ${theme === 'dark' ? 'bg-gray-800' : 'bg-white'} rounded-3xl shadow-2xl p-8 border border-gray-100 dark:border-gray-700`}>
            <div className="text-center mb-8">
              <h2 className={`text-3xl font-bold mb-2 ${theme === 'dark' ? 'text-white' : 'text-slate-800'}`}>Everything You Need</h2>
              <p className={`text-lg ${theme === 'dark' ? 'text-slate-300' : 'text-slate-600'}`}>Powerful features designed for educational excellence</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className={`group flex items-start gap-4 p-6 ${theme === 'dark' ? 'bg-gray-700 hover:bg-gray-600' : 'bg-slate-50 hover:bg-blue-50'} rounded-2xl transition-all duration-300 hover:shadow-lg hover:scale-105`}>
                ...
                <div className="flex-1">
                  <div className={`font-bold text-lg mb-2 ${theme === 'dark' ? 'text-white' : 'text-slate-800'}`}>Unlimited Student Monitoring</div>
              ...
              <div className={`group flex items-start gap-4 p-6 ${theme === 'dark' ? 'bg-gray-700 hover:bg-gray-600' : 'bg-slate-50 hover:bg-yellow-50'} rounded-2xl transition-all duration-300 hover:shadow-lg hover:scale-105`}>
                ...
                <div className="flex-1">
                  <div className={`font-bold text-lg mb-2 ${theme === 'dark' ? 'text-white' : 'text-slate-800'}`}>Automated Risk Alerts</div>
              ...
              <div className={`group flex items-start gap-4 p-6 ${theme === 'dark' ? 'bg-gray-700 hover:bg-gray-600' : 'bg-slate-50 hover:bg-purple-50'} rounded-2xl transition-all duration-300 hover:shadow-lg hover:scale-105`}>
                ...
                <div className="flex-1">
                  <div className={`font-bold text-lg mb-2 ${theme === 'dark' ? 'text-white' : 'text-slate-800'}`}>AI-Powered Interventions</div>
              ...
              <div className={`group flex items-start gap-4 p-6 ${theme === 'dark' ? 'bg-gray-700 hover:bg-gray-600' : 'bg-slate-50 hover:bg-green-50'} rounded-2xl transition-all duration-300 hover:shadow-lg hover:scale-105`}>
                ...
                <div className="flex-1">
                  <div className={`font-bold text-lg mb-2 ${theme === 'dark' ? 'text-white' : 'text-slate-800'}`}>Easy Data Import</div>
              ...
              <div className={`group flex items-start gap-4 p-6 ${theme === 'dark' ? 'bg-gray-700 hover:bg-gray-600' : 'bg-slate-50 hover:bg-indigo-50'} rounded-2xl transition-all duration-300 hover:shadow-lg hover:scale-105`}>
                ...
                <div className="flex-1">
                  <div className={`font-bold text-lg mb-2 ${theme === 'dark' ? 'text-white' : 'text-slate-800'}`}>Advanced Analytics Dashboard</div>
              ...
              <div className={`group flex items-start gap-4 p-6 ${theme === 'dark' ? 'bg-gray-700 hover:bg-gray-600' : 'bg-slate-50 hover:bg-red-50'} rounded-2xl transition-all duration-300 hover:shadow-lg hover:scale-105`}>
                ...
                <div className="flex-1">
                  <div className={`font-bold text-lg mb-2 ${theme === 'dark' ? 'text-white' : 'text-slate-800'}`}>Multi-User Support</div>
              ...
              <div className={`group flex items-start gap-4 p-6 ${theme === 'dark' ? 'bg-gray-700 hover:bg-gray-600' : 'bg-slate-50 hover:bg-cyan-50'} rounded-2xl transition-all duration-300 hover:shadow-lg hover:scale-105`}>
                ...
                <div className="flex-1">
                  <div className={`font-bold text-lg mb-2 ${theme === 'dark' ? 'text-white' : 'text-slate-800'}`}>Class Management</div>
              ...
              <div className={`group flex items-start gap-4 p-6 ${theme === 'dark' ? 'bg-gray-700 hover:bg-gray-600' : 'bg-slate-50 hover:bg-emerald-50'} rounded-2xl transition-all duration-300 hover:shadow-lg hover:scale-105`}>
                ...
                <div className="flex-1">
                  <div className={`font-bold text-lg mb-2 ${theme === 'dark' ? 'text-white' : 'text-slate-800'}`}>Multi-Language Support</div>
              ...
              <div className={`group flex items-start gap-4 p-6 ${theme === 'dark' ? 'bg-gray-700 hover:bg-gray-600' : 'bg-slate-50 hover:bg-violet-50'} rounded-2xl transition-all duration-300 hover:shadow-lg hover:scale-105`}>
                ...
                <div className="flex-1">
                  <div className={`font-bold text-lg mb-2 ${theme === 'dark' ? 'text-white' : 'text-slate-800'}`}>Google Translate Integration</div>
              ...
              <div className={`group flex items-start gap-4 p-6 ${theme === 'dark' ? 'bg-gray-700 hover:bg-gray-600' : 'bg-slate-50 hover:bg-rose-50'} rounded-2xl transition-all duration-300 hover:shadow-lg hover:scale-105`}>
                <div className="w-12 h-12 bg-gradient-to-br from-rose-500 to-pink-600 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
                  <Headphones className="w-6 h-6 text-white" />
                </div>
                <div className="flex-1">
                  <div className={`font-bold text-lg mb-2 ${theme === 'dark' ? 'text-white' : 'text-slate-800'}`}>Priority Support</div>
